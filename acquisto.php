...
<html>
	...
	<body class="Body">				
		...
		<div id="back">
			...
			<p class="contentTitle">Acquista un prodotto!</p>
			<form method="post" onSubmit="return verifica(this);" name="dati" action="acquistato.php">
				<center>
					<table>
						...
						<tr><td id="tdPrenota"> Prodotto</td><td><select id="prod" name="prod" onchange="prodSel()"><?php echo "<option disabled selected value> -- scegli prodotto -- </option>"; foreach($prod as $k => $val) echo "<option value=\"$val\">$val</option>"; ?></select></td></tr>
						<tr><td id="tdPrenota"> Quantità</td><td align="left"><input type="number" min="1" name="qu"/></td></tr>
					</table>
