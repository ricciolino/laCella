<html>
	...
	<div class="outer">
		<div class="middle">
			<center>
				<p id="enterPlogin">Registrati</p>
				<div id="divLogin">
					<form action="signedinita.php" method="post" onsubmit="verifica(this)">
						<table>
							<tr><td id="tdPrenota"> Nome: </td><td> <input type="text" name="nome" size="30" maxlength="30" /></td></tr>
							<tr><td id="tdPrenota"> Cognome: </td><td> <input type="text" name="cognome" size="30" maxlength="30" /></td></tr>
							<tr><td id="tdPrenota"> SSN: </td><td> <input type="text" name="cf" size="16" maxlength="16" minlength="16" /></td></tr>
							<tr><td id="tdPrenota"> Nazione: </td><td> <input type="text" name="naz" size="20" maxlength="20" /></td></tr>
