	...
	<body class="Body">
		...
		<div id="back">
			...
			<?php
				...
				echo "<center><h2 style=\"color:#a15425;margin-bottom:0px\">Acquisto effetuato con successo!</h2></center>";
				...
				echo "<center><table>
						...
						<tr><td style=\"text-align:right;font-family:Courier;color:#a15425\">Prodotto:</td><td style=\"font-size:18.5px;color:#a15425;font-weight:bold\">$p_name</td></tr>
						<tr><td style=\"text-align:right;font-family:Courier;color:#a15425\">Quantità:</td><td style=\"font-size:18.5px;color:#a15425;font-weight:bold\">$q</td></tr>";
