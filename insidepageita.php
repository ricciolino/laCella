...
<div class="outer">
	<div class="middle">
		<center>
			<div id="divLogin">
				<p id="welcome">Benvenuto <?php echo $us; ?></p>
				<?php
					...
					echo "<div style=\"float:left;width:50%;\"><h2 style=\"color:#a15425;padding-right:30%;\">Storico prenotazioni:</h2>";echo "<ul>";
					while($p=pg_fetch_row($prenotazioni)) echo "<li style=\"color:#a15425;\">prenotato appartamento ".$p[0]." dal ".$p[1]." al ".$p[2]." per ".$p[3]." persona/e</li>"; echo "</ul>";
					...
					echo "</div><div style=\"float:right;width:50%;\"><h2 style=\"color:#a15425;\">Storico acquisti:</h2>";echo "<ul style=\"text-align:left;padding-left:33%;\">";
					while($a=pg_fetch_row($acquisti)) echo "<li style=\"color:#a15425;\">acquistato/i ".$a[1]." di ".$a[0]."</li>"; echo "</ul></div>";
				?>
			</div>
		</center>
	</div>
