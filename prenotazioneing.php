		...
		<div id="back">
			...
			<div class="menu">
				<ul id="links">
					...
					<li><a href="prodottiita.html">Typical products</a></li>
					<li><a href="prenotaita.php">Booking</a></li>
				</ul>
			</div>
			<?php
				...
				if($number>$flat_cap) echo "<center><h4 style=\"color:#a15425;margin-bottom:0px\">number of people can not exceed the capacity of the apartment (max ".$flat_cap." people)</h4></center>";
				else{
					...
					echo "<center><h2 style=\"color:#a15425;margin-bottom:0px\">Successful booking!</h2></center>";
					...
					echo "<center><table>
							...
							<tr><td style=\"text-align:right;font-family:Courier;color:#a15425\">Arrive date:</td><td style=\"font-size:18.5px;color:#a15425;font-weight:bold\">$arrive</td></tr>
							<tr><td style=\"text-align:right;font-family:Courier;color:#a15425\">Departed date:</td><td style=\"font-size:18.5px;color:#a15425;font-weight:bold\">$departure</td></tr>
							<tr><td style=\"text-align:right;font-family:Courier;color:#a15425\">Apartment:</td><td style=\"font-size:18.5px;color:#a15425;font-weight:bold\">$flat_name</td></tr>
							<tr><td style=\"text-align:right;font-family:Courier;color:#a15425\">People number:</td><td style=\"font-size:18.5px;color:#a15425;font-weight:bold\">$number</td></tr>";
					...
					$result=pg_query($dbconn,$query);
					if(!$result){echo "<center><small>query \"$query\" failed</small></center><br/><br/>";exit;}
					  echo "<tr><td style=\"text-align:right;font-family:Courier;color:#a15425\">Total price:</td><td style=\"font-size:18.5px;color:#a15425;font-weight:bold\">$prezzo euro</td></tr>
						</table></center><br/>";
				}
			?>
